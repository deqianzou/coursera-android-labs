...
public class ActivityLoaderActivity extends Activity {
	...
	private void startImplicitActivation() {
		...
		Intent implicitIntent = new Intent(Intent.ACTION_VIEW, myUri); // param1: action; param2: data
		
        Intent baseIntent = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if((requestCode == GET_TEXT_REQUEST_CODE) && (resultCode == RESULT_OK)){
			mUserTextView.setText(data.getExtras().getString("input"));
		}
